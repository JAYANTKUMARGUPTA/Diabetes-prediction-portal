...
const DiabetesPredictionPortal = ({ darkMode, toggleDarkMode }) => {
  const [formData, setFormData] = useState({
    age: "",
    weight: "",
    height: "",
  ...
  return (
    <div className={`min-h-screen ${darkMode ? "bg-gray-900 text-white" : "bg-gray-100 text-gray-900"} py-12 px-4 sm:px-6 lg:px-8`}>
      <div className="max-w-7xl mx-auto">
        ...
        <h1 className={`text-4xl font-bold text-center ${darkMode ? "text-violet-400" : "text-violet-600"} mb-12`}>Diabetes Risk Prediction Portal</h1>
        <div className={`${darkMode ? "bg-gray-800" : "bg-white"} shadow-xl rounded-lg overflow-hidden`}>
          <div className="md:flex">
            <div className="md:w-1/2 p-8">
              <h2 className="text-2xl font-semibold mb-6">Enter Your Information</h2>
              <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div key={id}>
                    ...
                    <div className="mt-1 relative rounded-md shadow-sm">
                      ...
                      <input
                        ...
                        name={id}
                        id={id}
                        className={`focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-10 sm:text-sm border-gray-300 rounded-md ${darkMode ? "bg-gray-700 text-white" : ""}`}
                        placeholder={`Your ${label.toLowerCase()}`}
                        value={formData[id]}
                        onChange={handleInputChange}
                      />
            ...
            <div className={`md:w-1/2 ${darkMode ? "bg-gray-700" : "bg-indigo-50"} p-8 m-4`}>
              <h2 className="text-2xl font-semibold mb-6">Risk Prediction Result</h2>
              {prediction ? (
                <div className={`${darkMode ? "bg-gray-600" : "bg-white"} p-6 rounded-lg shadow-md`}>
                  <h3 className="text-xl font-semibold mb-4">Your Diabetes Risk:</h3>
                  <p className={`text-3xl font-bold ${prediction === "Low"
                    ? "text-green-600"
                    : prediction === "Moderate"
                  ...
                  <p className={`mt-4 ${darkMode ? "text-gray-300" : "text-gray-600"} rounded-xl`}>
                    This prediction is based on the information you provided. Please consult with a healthcare professional for a more accurate assessment.
                  </p>
                </div>
              ) : (
                <p className={`${darkMode ? "text-gray-300" : "text-gray-600"}`}>Enter your information and click the predict button to see your diabetes risk assessment.</p>
              )}
              ...
              <div className="mt-8">
                <h3 className="text-xl font-semibold mb-4">Note</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600">
                  <li>The diagnosis of Diabetes requires a fasting plasma glucose of greater or = 126 mg/dL or a random / 2 hr post glucose value of greater or = 200 mg/dL on at least 2 occasions.</li>
                </ul>
              </div>
              ...
              <div className="mt-8">
                <h3 className="text-xl font-semibold mb-4">HbA1c (Hemoglobin A1c)</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600">
                  <li><strong>Below- 5.7%: </strong><br /><li><strong>Normal:</strong> This indicates normal blood sugar levels. People with HbA1c below 5.7% are considered to have a low risk of diabetes.</li></li>
                  <li><strong>5.7% to 6.4%: </strong><br /><li><strong>Prediabetes:</strong> This range indicates an increased risk of developing type 2 diabetes. It suggests impaired glucose tolerance and insulin resistance.</li></li>
                  <li><strong>6.5% and above: </strong><br /><li><strong>Diabetes:</strong> An HbA1c level of 6.5% or higher, confirmed by multiple tests, indicates diabetes. This means blood sugar levels have been consistently high over the past few months.</li></li>
                </ul>
              </div>
...
const WelcomePage = ({ setCurrentPage, darkMode, toggleDarkMode }) => (
  <div className={`min-h-screen ${darkMode ? "bg-gray-900 text-white" : "bg-gradient-to-r from-slate-300 to-slate-500"} flex flex-col justify-center items-center p-4`}>
    <div className="max-w-3xl w-full bg-white rounded-lg shadow-xl overflow-hidden">
      <div className="md:flex">
        <div className="md:flex-shrink-0">
          <img
    ...
    <button
      onClick={toggleDarkMode}
      className="mt-4 p-2 rounded-full bg-indigo-600 text-white hover:bg-indigo-700"
    >
      {darkMode ? <FaSun /> : <FaMoon />}
    </button>
  </div>
...
const App = () => {
  ...
  return currentPage === "welcome" ? (
    <WelcomePage setCurrentPage={setCurrentPage} darkMode={darkMode} toggleDarkMode={toggleDarkMode} />
  ) : (
    <DiabetesPredictionPortal darkMode={darkMode} toggleDarkMode={toggleDarkMode} />
  );
};
